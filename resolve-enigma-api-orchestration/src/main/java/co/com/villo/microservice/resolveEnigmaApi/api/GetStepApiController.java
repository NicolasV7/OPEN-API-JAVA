...
import co.com.villo.microservice.resolveEnigmaApi.services.RestTemplateService;
...
public class GetStepApiController implements GetStepApi {
    ...
    private List<JsonApiBodyResponseErrors> createResponseErrors(JsonApiBodyRequest body) {
    	...
    	errorDetail.setDetail("Enigma: " + body.getData().get(0).getEnigma() + " not supported - Expected: How to put a 🦒 into a refrigerator?");
    ...
    private List<JsonApiBodyResponseSuccess> createResponseSuccess(JsonApiBodyRequest body) {
        ...
        ResponseEntity<String> stepOne = restTemplateService.getStep("http://localhost:8090/v1/getOneEnigma/get-One");
        ResponseEntity<String> stepTwo = restTemplateService.getStep("http://localhost:8092/v1/getOneEnigma/get-Two");
        ResponseEntity<String> stepThree = restTemplateService.getStep("http://localhost:8094/v1/getOneEnigma/get-Three");
